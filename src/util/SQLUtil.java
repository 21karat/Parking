...
public class SQLUtil {
	...
	public static int executeNonQuery(String sqlCmd,Object[] objList){
		...
		try {
			conn=util.ConnectionFactory.getConnection();//获取数据库连接对象
			...
			util.CloseFactory.close(conn,sm);//关闭相应资源
			return result;
		}
	}
	...
	public static List<Object> executeQuery(String sqlCmd,Object[] objList){
		...
		try{
			...
			util.CloseFactory.close(conn,sm,rSet);
			return list;
		}
	}
	...
	public static Object excuteScalar(String sqlCmd,Object[] objList){
		...
		try {
			...
			if(objList!=null){
				...
				conn=util.ConnectionFactory.getConnection();
